...
- Missing viewport-toolbar contrast maps to `EditorStyles.ContextualToolbar`. Godot modern and Minimal Theme give the 2D/3D contextual toolbar a higher surface than the main content; theme that slot directly instead of broadening `PanelContainer` or the editor viewport background.
