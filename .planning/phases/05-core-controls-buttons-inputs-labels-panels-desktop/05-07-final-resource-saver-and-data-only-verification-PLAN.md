...
- Final verifier loads each approved direction with `raised=false` and asserts every generated `StyleBoxFlat.shadow_size == -1`; only `raised=true` may produce hard-offset shadow values.
