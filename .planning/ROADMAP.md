...
- [x] **Phase 9: Showcase + Token Gallery + Theme Picker** - editor-authored `res://main.tscn` with 9 sections + dropdown theme picker (Pulse/Slate/Bubble/Daybreak/Burst + Godot default); raised/platform remain resource exports, not showcase runtime controls (completed 2026-05-07; corrected 2026-05-08)
