...
Plans:
- [x] `09-01-PLAN.md` — Implement the showcase scene with nine editor-authored sections, dropdown-only direction/default theme picker, minimal behavior glue, token gallery, and coverage strip.
**UI hint**: yes
