...
- [x] **Phase 9: Showcase + Token Gallery + Theme Picker** - editor-authored `res://main.tscn` with 9 sections + reusable `NeoCadeThemeSwitcher` dropdown that discovers themes from `addons/neocade_theme/`, keeps optional `Default` first, then sorts themes alphabetically; raised/platform remain resource exports, not showcase runtime controls (completed 2026-05-07; corrected 2026-05-08)
