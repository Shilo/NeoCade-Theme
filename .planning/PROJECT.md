...
- **Type variations**: the live `TYPE_VARIATIONS` registry contains 67 entries as of 2026-05-13: core runtime variations, 14 opt-in role/action/surface-text variations, and editor/integration variations.
...
---
*Last updated: 2026-05-13 — synchronized with current implementation: canonical resource, 11 exports, source-color role palette, autoload helper, 10-section showcase, BINDING_TABLE=155, TYPE_VARIATIONS=67*
