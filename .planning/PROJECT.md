...
- **Type variations**: the live `TYPE_VARIATIONS` registry contains 63 entries as of 2026-05-13: core runtime variations, 10 opt-in role/action variations, and editor/integration variations.
...
---
*Last updated: 2026-05-13 — synchronized with current implementation: canonical resource, 12 exports, autoload helper, 10-section showcase, BINDING_TABLE=150, TYPE_VARIATIONS=62*
