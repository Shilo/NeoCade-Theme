...
- 15-phase roadmap with goals + success criteria + cumulative reqs (Phase 3 REDIRECTED 2026-05-04 → Phase 3.1 + 3.2 + 3.3 + 3.4 inserted; architecture revised 2026-05-04 → NeoCadeTheme superclass + per-theme subclasses; 3.3 inserted as theme-direction research deriving 5 NEW directions from user goals + restrictions + v0 DNA, NOT v0 carryovers): [.planning/ROADMAP.md](.planning/ROADMAP.md)
