...
const BINDING_TABLE: Dictionary = {
	...
	"CheckBox": {
		"stylebox": {
			...
			"hover_mirrored": {"role": "state_hover",   "raised_intensity": 0, "alpha": 0.0, "border_width": 0},
			"pressed":        {"role": "state_pressed", "raised_intensity": 0, "alpha": 0.0, "border_width": 0},
			"pressed_mirrored":{"role": "state_pressed", "raised_intensity": 0, "alpha": 0.0, "border_width": 0},
			"focus":          {"role": "focus_ring"},
			...
			"hover_pressed_mirrored":{"role": "state_pressed", "raised_intensity": 0, "alpha": 0.0, "border_width": 0},
		},
		"color": {
			"font_color":              {"role": "text_strong"},
			"font_hover_color":        {"role": "text_strong"},
	...
	"HScrollBar": {
		"stylebox": {
			...
			"grabber_highlight": {"role": "text_strong", "raised_intensity": 0,
								  ...
								  "padding": Vector2i(4, 4), "border_width": 0},
	...
	"SpinBox": {
		...
		"icon": {
			...
			# EditorSpinSlider currently requests this composite slot through
			# the SpinBox theme type even though it also binds EditorSpinSlider
			# updown slots.
			"updown":          {"icon": "tree_updown"},
			"updown_disabled": {"icon": "tree_updown"},
		},
